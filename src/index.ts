...
export namespace Handler {
    ...
    export namespace ApiGateway {
        export type Authorizer = FunctionHandler<Authorizer.Event, Authorizer.Result>;
    }
    // Backward compatibility
    export type ApiGatewayAuthorizer = ApiGateway.Authorizer

    export type Http = FunctionHandler<Http.Event, Http.Result>;
    export type ObjectStorage = FunctionHandler<ObjectStorage.Event, Http.Result>;
    ...
    export type ContainerRegistry = FunctionHandler<ContainerRegistry.Event, Http.Result>;
